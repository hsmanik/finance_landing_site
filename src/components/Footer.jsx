    ...
    <div className=" max-w-[1240px] mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-gray-300">
      <div>
        ...
        <p className=" py-4">
          ...
          ipsum veritatis cumque doloribus hic repellat consectetur
          necessitatibus vero, reiciendis nobis minus voluptatem facere eum
          vitae neque, dolor libero nesciunt?
        </p>
